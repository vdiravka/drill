...
public class JoinTestBase extends PlanTestBase {
  ...
  public static final String DISABLE_HJ = "alter session set `planner.enable_hashjoin` = false";
  public static final String ENABLE_HJ = "alter session set `planner.enable_hashjoin` = true";
  public static final String RESET_HJ = "alter session reset `planner.enable_hashjoin`";
  public static final String DISABLE_MJ = "alter session set `planner.enable_mergejoin` = false";
  public static final String ENABLE_MJ = "alter session set `planner.enable_mergejoin` = true";
  public static final String DISABLE_NLJ_SCALAR = "alter session set `planner.enable_nljoin_for_scalar_only` = false";
  public static final String ENABLE_NLJ_SCALAR = "alter session set `planner.enable_nljoin_for_scalar_only` = true";
  public static final String DISABLE_JOIN_OPTIMIZATION = "alter session set `planner.enable_join_optimization` = false";
  public static final String RESET_JOIN_OPTIMIZATION = "alter session reset `planner.enable_join_optimization`";
