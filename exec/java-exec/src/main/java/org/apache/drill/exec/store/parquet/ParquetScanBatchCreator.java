    ...
    for(RowGroupReadEntry e : rowGroupScan.getRowGroupReadEntries()){
      ...
      */
      try {
        ...
        ParquetReaderUtility.DateCorruptionStatus containsCorruptDates = ParquetReaderUtility.detectCorruptDates(footers.get(readEntryPath), rowGroupScan.getColumns(),
