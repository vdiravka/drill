...
public class MetadataContext {
  ...
  public void clear() {
    ...
    setMetadataCacheCorruptionStatus(false);
  }
  ...
  /**
   * @return true if parquet metadata cache files are missing or corrupted,
   *         false otherwise
   */
  public boolean isMetadataCacheCorrupted() {
   ...
   *
   * @param metadataCorruptionStatus metadata corruption status
   */
  public void setMetadataCacheCorruptionStatus(boolean metadataCorruptionStatus) {
    isMetadataCacheCorrupted = metadataCorruptionStatus;
  }
