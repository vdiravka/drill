...
public class Metadata {
  ...
  public static @Nullable ParquetTableMetadataDirs readMetadataDirs(FileSystem fs, Path path,
      MetadataContext metaContext, ParquetFormatConfig formatConfig) throws IOException {
   ...
   * @throws IOException is thrown in case of problems while executing the list of runnables
   */
...
//    Map<SchemaPath, OriginalType> originalTypeMap = Maps.newHashMap();
  ...
  /**
   * Basic class for parquet metadata. Inheritors of this class are json serializable structures
   * which contain the metadata for an entire parquet directory structure
   * <p>
