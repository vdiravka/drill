...
public class SchemalessScan extends AbstractGroupScan implements SubScan {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(SchemalessScan.class);
  ...
  public PhysicalOperator getNewWithChildren(List<PhysicalOperator> children) throws ExecutionSetupException {
    logger.error("Dummy group scan 5");
//    return new UnionAll();
  ...
  public GroupScan clone(List<SchemaPath> columns) {
    logger.error("Dummy group scan 6");
    return this;
  }

  @Override
  public ScanStats getScanStats() {
    logger.error("Dummy group scan 7");
